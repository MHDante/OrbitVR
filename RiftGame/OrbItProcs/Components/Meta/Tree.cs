...
namespace OrbItProcs {
  ...
  /// </summary>
  [Info(UserLevel.User, "After a short interval, this node spawns smaller nodes that share it's characteristics.",
    CompType)]
  public class Tree : Component {
    ...
    [Info(UserLevel.Developer)] public int depth;
    ...
    public int maxChilds {
      ...
      set { _maxChilds = value > 15 ? 15 : value; }
    }
