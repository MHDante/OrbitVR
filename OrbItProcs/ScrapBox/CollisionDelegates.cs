...
namespace OrbItProcs {
  public static class CollisionDelegates {
    ...
    public static Action<Node, Node> absorbColor = delegate(Node source, Node target) {
                                                     if (target == null) return;
                                                     int div = 25;
                                                     int r = (int) source.body.color.R +
                                                             ((int) target.body.color.R - (int) source.body.color.R)/div;
                                                     int g = (int) source.body.color.G +
                                                             ((int) target.body.color.G - (int) source.body.color.G)/div;
                                                     int b = (int) source.body.color.B +
                                                             ((int) target.body.color.B - (int) source.body.color.B)/div;
