  ...
  public class Body : Collider {
    ...
    public float mass {
      ...
      set {
        ...
        else invmass = 1.0f/value;
      } //infinite mass is represented by 0
    }
    ...
    public override void CheckCollisionBody(Body other) {
      ...
      if (m.contact_count > 0) {
        ...
        if (other.HandlersEnabled) {
          ...
          if (otherEnter || other.OnCollisionExit != null || other.OnCollisionFirstEnter != null ||
              other.OnCollisionAllExit != null) {
