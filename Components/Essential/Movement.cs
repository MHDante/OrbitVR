...
namespace OrbitVR.Components.Essential {
  ...
  public class Movement : Component {
    ...
    public Toggle<float> maxVelocity {
      get { return _maxVelocity; }
      set {
        _maxVelocity = value;
        if (maxVelocity < _minVelocity) _maxVelocity = _minVelocity;
      }
    }
    ...
    public Toggle<float> minVelocity {
      get { return _minVelocity; }
      set {
        _minVelocity = value;
        if (_minVelocity > _maxVelocity) _minVelocity = _maxVelocity;
      }
    }
